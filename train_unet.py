...
def train(model, data_path, batch_size, n_epochs, transform, save_dir=None):
    ...
    for epoch in tqdm(range(n_epochs)):
        ...
        print(f"Epoch {epoch + 1}, Train Loss: {average_train_loss:.4f}, Validation Loss: {average_val_loss:.4f}, Validation SNR: {average_snr_score:.4f}, Average PESQ: {average_pesq_score:.4f}, Average STOI: {average_stoi_score:.4f}")
